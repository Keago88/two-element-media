    ...
    <section className="relative border-b border-white/10">
      <div className="hero-stage relative overflow-clip">
        ...
        <Parallax
          ...
          mode="hero"
        >
          <BrandMark className="h-16 w-auto opacity-50 sm:h-20" title="Two Element" />
        </Parallax>
        <div className="relative z-[3] mx-auto flex min-h-[calc(100svh-4.5rem)] w-full max-w-[1120px] items-center px-5 py-24 sm:px-8 lg:py-32">
          <div className="max-w-4xl">
            <p className="font-heading animate-enter text-xs font-semibold tracking-[0.32em] text-muted-foreground uppercase">
